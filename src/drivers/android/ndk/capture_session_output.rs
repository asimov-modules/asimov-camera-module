...
pub struct CaptureSessionOutput {
    handle: *mut ndk::ACaptureSessionOutput,
}

impl CaptureSessionOutput {
    #[inline]
    pub fn as_ptr(&self) -> *mut ndk::ACaptureSessionOutput {
        self.handle
    }
    ...
    pub fn new(window: *mut ndk::ANativeWindow) -> CameraResult<Self> {
        ...
        let st = unsafe { ndk::ACaptureSessionOutput_create(window, &mut out.handle) };
    ...
    pub fn close(&mut self) {
        ...
        unsafe { ndk::ACaptureSessionOutput_free(self.handle) };
